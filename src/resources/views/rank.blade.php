...
<head>
    ...
    <style>
        body { font-family: ui-sans-serif, system-ui, Arial, sans-serif; max-width: 780px; margin: 32px auto; padding: 0 16px; }
        label { display: block; margin: 12px 0 4px; font-weight: 600; }
        input { width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; }
        button { margin-top: 16px; padding: 10px 16px; border-radius: 8px; border: 0; background: #111827; color: #fff; cursor: pointer; }
        .card { margin-top: 20px; padding: 16px; border: 1px solid #eee; border-radius: 12px; background: #fafafa; }
